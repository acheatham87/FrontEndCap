...
export const GoalCard = ({ goal }) => {    
    ...
    return(
        <div className="goal-card">
            <h3 className='goal-card-header'>Previous Goals</h3>
            ...
            <button type='button' className='goal-card-edit'>Edit</button>
            <button type="button" className='goal-card-delete'>Delete</button>
        </div>
    )
}